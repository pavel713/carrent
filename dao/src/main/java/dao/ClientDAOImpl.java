...
public class ClientDAOImpl implements ClientDAO {
    ...
    private static final String FIND_USER_WHERE_NAME_AND_PASSWORD = "select client.password from client where name=(?)";
    ...
    public boolean findByNameAndPassword(Client client) {
        ...
        try (Connection connection = ConnectionManager.getConnection()) {
            PreparedStatement preparedStatement = connection.prepareStatement(FIND_USER_WHERE_NAME_AND_PASSWORD);
            preparedStatement.setString(1, client.getName());
    ...
    private void setProps(Client client, ResultSet resultSet) throws SQLException {
